...
# Example: connect to a BrAPI endpoint
con <- brapi_connect(
  url = "https://example.brapi.server"
)

# Example: fetch studies and convert to a tibble
studies <- brapi_get_studies(con)

head(studies)
```

*(Replace with real functions once the API stabilizes.)*
